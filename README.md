...
- `/agent` command parser and executor for project/session routing, turn enqueueing, queue list/remove/clear/move, lease control, and idempotent invocation handling.
...
or clear/reorder queues, `session_send` to enqueue session turns or remove queued Turns,
