...
the manifest. Repeated artifact paths inside the same section or malformed sha256
digests are malformed evidence and fail the section. Unknown, duplicate, missing-id, or
