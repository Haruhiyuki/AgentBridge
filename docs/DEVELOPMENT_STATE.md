...
- Production API/WebSocket hardening with full certificate issuance/rotation workflows, native TLS termination guidance, and deeper command/payload-aware or method-specific resource/action device authorization beyond the current token-file/device-key/client-cert-fingerprint, transport-scope, and visible resource-ID gates.
...
3. Extend the HTTP API/WebSocket/admin/device-key/client-cert-fingerprint gates with full certificate issuance/rotation workflows and deeper command/payload-aware or method-specific resource/action device authorization.
