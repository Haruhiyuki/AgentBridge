...
- Production API/WebSocket hardening with full certificate issuance/rotation workflows, native TLS termination guidance, and body-aware or method-specific resource/action device authorization beyond the current token-file/device-key/client-cert-fingerprint, transport-scope, and path/query resource-ID gates.
...
3. Extend the HTTP API/WebSocket/admin/device-key/client-cert-fingerprint gates with full certificate issuance/rotation workflows and body-aware or method-specific resource/action device authorization.
