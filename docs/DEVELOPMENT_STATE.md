...
- Production API/WebSocket hardening with full certificate issuance/rotation workflows, native TLS termination guidance, and finer-grained resource/action-scoped device authorization beyond the current token-file/device-key/client-cert-fingerprint and transport-scope gates.
...
3. Extend the HTTP API/WebSocket/admin/device-key/client-cert-fingerprint gates with full certificate issuance/rotation workflows and finer-grained resource/action-scoped device authorization.
